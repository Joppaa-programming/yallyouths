                ...
                <div className='opacity-70 w-full h-full bg-black relative'>
                    ...
                    <div className="container bottom-0 hero-content opacity-100  flex absolute flex-col items-center  ">
                        ...
                        <div className="w-full flex mt-2 justify-center items-center">
                            <span className=''>
                                <a href="#contactus" >
                                    <button className="hover:bg-yellow-800 hover:p-2 transition duration-150 ease-in-out lg:text-xl lg:font-bold   text-yellow-400 px-4 sm:px-10 border-4 border-yellow-400 py-2 sm:py-4 text-sm"> Donate</button>
                                </a>
